...
IDEAL_EDGES = [
    ('Living', 'Dining'), ('Dining', 'Kitchen'), ('Kitchen', 'Store'), ('Store', 'Toilet1'),
    ('Bedroom1', 'Bath1'), ('Bedroom2', 'Bedroom3'), ('Bedroom3', 'Toilet2')
]
...
# Streamlit UI
st.set_page_config(page_title="Room Plan Evaluator (Simplified)", layout="wide")
...
if st.button("Evaluate Plan"):
    ...
    ideal_graph = build_graph(IDEAL_ROOMS.keys(), "\n".join(f"{u}, {v}" for u, v in IDEAL_EDGES))
